...
public class MainFrame extends JFrame {
	...
	private MenuComparator comparatorMenu;
	...
	public MainFrame() {
		...
		openSecondDataItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				comparatorMenu.openFile(MenuComparator.SECOND_PICTURE);
			}
		});
		...
		saveDataItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Set<String> writerFormats = MenuComparator.getWriterFormats();
		...
		for (String format : MenuComparator.getWriterFormats()) {
